            ...
            <div className="chairman-card">
              ...
              <div className="chairman-text-col">
                ...
                <div className="chairman-nameplate">
                  <img src={assetPath("/img/logo_color.PNG")} alt="شعار مدينة الدلما" className="chairman-avatar-logo" />
                  <div>
              ...
              <div className="chairman-img-col">
                <img src={assetPath("/img/chairman_image.jpeg")} alt="رئيس مجلس إدارة مدينة الدلما الإنسانية" />
              </div>
