...
export default function HomePage() {
  ...
  preload(sitePath("/img/dalma_building.webp"), { as: "image" });
    ...
    <>
      ...
      <section className="hero">
        <div className="hero-bg">
          <img src={sitePath("/img/dalma_building.webp")} alt="مبنى مدينة الدلما الإنسانية" />
          ...
          <div className="about-grid">
            <div className="about-img-wrap">
              <div className="about-img-inner">
                <img src={sitePath("/img/section_image.webp")} alt="فريق مدينة الدلما الإنسانية" loading="lazy" />
              </div>
            </div>
            <div>
