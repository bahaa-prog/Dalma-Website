        ...
        <div className="footer-grid">
          <div>
            <div className="footer-logo-row">
              <img src="/img/logo_white.PNG" alt={common.logoAlt} className="footer-logo" />
              <img src="/img/rafq_white_logo.PNG" alt={dict.rafqLogoAlt} className="footer-logo footer-logo-lg" />
              <img src="/img/HR_white_logo.PNG" alt={dict.hrLogoAlt} className="footer-logo footer-logo-xl" />
            </div>
