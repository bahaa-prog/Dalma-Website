    ...
    <header id="site-header" className={scrolled ? "scrolled" : undefined}>
      <div className="header-inner">
        <div className="header-logos">
          <Link href={href("/")}>
            <img src={assetPath("/img/logo_color.PNG")} alt={common.logoAlt} className="header-logo" />
          </Link>
          <span className="header-logo-divider"></span>
          <img src={assetPath("/img/HR_logo.jpeg")} alt={dict.hrLogoAlt} className="header-hr-logo" />
        </div>
